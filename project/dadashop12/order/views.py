...
class AdvanceOrderView(View):
    ...
    def get_address(self, uid):
        ...
        for addr in aLL_address:
            ...
            if addr.is_default:
                ...
                address_no_detault.append(addr_dict)
        return address_default + address_no_detault
    ...
    def get(self, request, username):
        # 查询字符串 - 》settlement_type:0代表购物车,1代表立即购买
        # 地址：默认地址咋数组的最前方【即0号索引】
...
class OrderInfoView(View):
    ...
    def del_carts_order_data(self,uid,skui_ids):
        carts_obj=CartsView()
        for sku_id in skui_ids:
    ...
    def post(self, request, username):
        ...
        try:
            ...
            return JsonResponse({'code': 10501, 'errmsg': 'The address is errod'})
        ...
        with transaction.atomic():
            ...
            for sku in skus:
                ...
                if carts_count > sku.stock:
                    ...
                    return JsonResponse({'code': 150502, 'errmsg': '商品【%s】库存不足' % sku.name})
                ...
                if result == 0:
                    # 库存发生变化
                    transaction.savepoint_rollback(sid)
                    return JsonResponse({'code': 10503, 'errmsg': '服务器有点忙，请稍后重试'})
